...
The content of the resume should not sound like its generated by AI. It should be natural and human like. The resume should be tailored to the job description and should highlight the skills and experiences mentioned in the self description. The HTML should be well structured and formatted, ready to be converted to PDF using a library like Puppeteer. You can highlight the content using some colors or different font styles but the overall design should be simple and professional.Keep the font size smaller of the content so that it can be fit in one page. The content should be ATS friendly i.e. it should be easily readable by Applicant Tracking Systems without losing important information.
The resume should not be so lengthy, it should ideally be 1 page only when converted to PDF. Focus on quality rather than quantity and make sure to include all relevant information that can increase the chances of getting an interview call for the given job description.
...
- Do NOT add explanations
- Follow schema exactly
-All page margins are already handled by Puppeteer.
Do not add any margin or padding to body or outer containers.Only generate the resume page no space outside the page.
